...
/*************************************************************************/
/* check the data to be encrypted in private key if it is digested 
 * and packeged. added on April 11, 1999 */
int KE_CheckDigestInfo(unsigned char * digestInfo,unsigned int digestLen);
/*************************************************************************/
