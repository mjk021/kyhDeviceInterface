...
#ifndef __DES_INLINE_FOR_FTSAFE_H__
#define __DES_INLINE_FOR_FTSAFE_H__
...
/*  				data uncryption 				*/
/*--------------------------------------------------*/
void undes(unsigned char m_bit[8], unsigned char k_bit[8],
		unsigned char e_bit[8])
...
#endif // __DES_INLINE_FOR_FTSAFE_H__
