 ...
 */
extern scconf_list *scconf_list_add(scconf_list ** list1, const char *value);
...
/* Free list structure
 */
extern void scconf_list_destroy(scconf_list * list1);

/* Return the length of an list array
 */
extern int scconf_list_array_length(const scconf_list * list1);

/* Return the combined length of the strings on all arrays
 */
extern int scconf_list_strings_length(const scconf_list * list1);

/* Return an allocated string that contains all
 * the strings in a list separated by the filler
 * The filler can be NULL
 */
extern char *scconf_list_strdup(const scconf_list * list1, const char *filler);
 ...
 */
extern const char **scconf_list_toarray(const scconf_list * list1);
